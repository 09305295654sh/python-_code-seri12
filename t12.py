...
class ship(arcade.Sprite):
    ...
    def _init_(self):
       ...
       super()._init_(':resources:images/space_shooter/playerShip1_blue.png')
...
class Doshman(arcade.Sprite):
    ...
    def _init_(self,s):
       ...
       super()._init_(':resources:images/space_shooter/playerShip1_green.png')
...
class Tir(arcade.Sprite):
     ...
     def _init_(self,host):
       ...
       super()._init_(':resources:images/space_shooter/laserRed01.png')
...
class Bazi(arcade.Window):
    ...
    def _init_(self):
        ...
        super()._init_(S_W , S_H , 'welcome to airplane Game!')
